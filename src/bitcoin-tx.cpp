...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s anzucoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  anzucoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded anzucoin transaction") + "\n" +
              "  anzucoin-tx [options] -create [commands]   " + _("Create hex-encoded anzucoin transaction") + "\n" +
              "\n";

...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/anzucoin-project/anzucoin>";
    const std::string URL_WEBSITE = "<https://anzucoin.org>";
